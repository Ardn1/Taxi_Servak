	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h4">Заявки на регистрацию: <span class="text-muted">неполные</span></h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group mr-2">
                <a href="<?php echo base_url('my/orders');?>" class="btn btn-sm btn-outline-success">Новые</a>
                <a href="<?php echo base_url('my/orders/short');?>" class="btn btn-sm btn-success">Неполные</a>
			  	...
			  	<table class="table table-hover">
			    	...
			    	<tbody>
			    		...
			    		<tr>
			    			...
			    			<td class="text-right">
			    				<a href="<?php echo base_url('my/orders/edit/'.$data->id).'/2';?>" class="btn btn-outline-secondary btn-sm">Смотреть</a>
			    			</td>
			    		</tr>
			    		<?php endforeach; ?>
			    	</tbody>
