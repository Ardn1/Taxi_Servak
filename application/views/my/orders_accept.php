	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h4">Заявки на регистрацию: <span class="text-success">принятые</span></h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group mr-2">
                ...
                <a href="<?php echo base_url('my/orders/accepting');?>" class="btn btn-sm btn-success">Принятые</a>
                            ...
                            <th>
                                <div class="dropdown" id="mainB">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" onclick = "CreateAll()" style="cursor: pointer">Создать аккаунт</a>
    ...
    <script>
        ...
        var urlRegister = "<?php echo base_url('my/orders/created/');?>"
        ...
        async function CreateAll() {
            ...
            {
                if (all[i].checked == true)
                    await createOne(all[i].getAttribute("IDAPI"));
            }
            location.reload();
        }
